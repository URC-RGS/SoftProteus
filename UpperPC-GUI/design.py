...
class Ui_UpperPCGUI(object):
    ...
    def retranslateUi(self, UpperPCGUI):
        ...
        self.camera_up_set.setItemText(3, QCoreApplication.translate("UpperPCGUI", u"Share", None))
        ...
        self.camera_dowm_set.setItemText(3, QCoreApplication.translate("UpperPCGUI", u"Share", None))
        self.camera_dowm_set.setItemText(4, QCoreApplication.translate("UpperPCGUI", u"L!", None))
        ...
        self.led_on_set.setItemText(3, QCoreApplication.translate("UpperPCGUI", u"Share", None))
        ...
        self.led_off_set.setItemText(3, QCoreApplication.translate("UpperPCGUI", u"Share", None))
        ...
        self.arm_up_set.setItemText(3, QCoreApplication.translate("UpperPCGUI", u"Share", None))
        ...
        self.arm_down_set.setItemText(3, QCoreApplication.translate("UpperPCGUI", u"Share", None))
