...
# PATH_CONFIG = '/home/rock/SoftProteus/debag_rov/'
# PATH_LOG = '/home/rock/SoftProteus/debag_rov/log/'

# запуск на ноутбуке 
# PATH_CONFIG = '/Users/yarik/Documents/SoftProteus/debag_rov/'
...
#PATH_LOG = 'C:/DOCUMENTS/git_rep/SoftProteus/debag_rov/log/'
...
class RovPost:
    ...
    def run_command(self):
        ...
        while True:
            ...
            if len(self.mass_rate) >= 1000:
                print(sum(self.mass_rate) // 1000)
                self.mass_rate = []
            ...
            self.data_output['servo_cam'] = abs(data['servo_cam'])
